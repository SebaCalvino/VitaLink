-- ============================================================================
-- SCRIPT PARA ACTUALIZAR SP sp_InsertEstudioManual CON MODALIDAD
-- ============================================================================
-- Este SP ahora recibe el IdModalidad como parámetro del formulario
-- ============================================================================
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- 6. Verificar que la modalidad existe
        IF NOT EXISTS (SELECT 1 FROM Modalidad WHERE Id = @IdModalidad)
        BEGIN
            RAISERROR('La modalidad seleccionada no existe', 16, 1);
            RETURN;
        END
        ...
        BEGIN
            ...
            (
                @IdEncuentro, 
                @IdModalidad,  -- Usar la modalidad recibida como parámetro
                @NombreEstudio, 
                @Fecha, 
                ISNULL(@Observacion, '')
            );
